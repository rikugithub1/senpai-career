  ...
  return (
    <AuthLayout type="business">
      ...
      <div className="mb-8 text-center">
        ...
        >
          <Icon name="building-2" size={24} style={{ color: "white" }} />
        </div>
        ...
        <form onSubmit={handleSubmit} className="flex flex-col gap-4">
          <div>
            <label className="mb-1.5 block text-xs font-semibold" style={{ color: "var(--ink2)" }}>
              <T ja="企業名" en="Company Name" /> <span style={{ color: "var(--red)" }}>*</span>
            </label>
          ...
          <div>
            <label className="mb-1.5 block text-xs font-semibold" style={{ color: "var(--ink2)" }}>
              <T ja="担当者名" en="Contact Name" /> <span style={{ color: "var(--red)" }}>*</span>
            </label>
          ...
          <label className="flex items-start gap-2 text-[12px] cursor-pointer" style={{ color: "var(--ink2)" }}>
            <input
              type="checkbox"
              checked={agreed}
      ...
      <div className="mt-6 text-center">
        <Link href="/business" className="inline-flex items-center gap-1 text-xs font-medium hover:opacity-80" style={{ color: "var(--ink2)" }}>
