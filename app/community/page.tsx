...
export default function CommunityPage() {
  return (
    <div style={{ paddingTop: "var(--nav-height)" }}>
      {/* Teal branding applied by community layout */}
            ...
            <div>
              ...
              >
                <span className="ja-only">
                  先輩の声が、<br />あなたの<span style={{ color: "var(--color-accent)" }}>就活の道しるべ</span>に。
                </span>
                <span className="en-only">
                  Let senpai guide<br />your path to a <span style={{ color: "var(--color-accent)" }}>career in Japan</span>.
                </span>
              </h1>
      ...
      {/* FOOTER                                                   */}
      {/* ═══════════════════════════════════════════════════════ */}
      <Footer subdomain="app.senpaicareer.com" />
    </div>
  );
}
